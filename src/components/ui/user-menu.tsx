  ...
  return (
    <div className="relative">
      <Button
        ...
        size="icon"
        onClick={toggleMenu}
        className="bg-black/30 backdrop-blur-md text-white shadow-xl rounded-xl hover:bg-black/40 active:bg-black/40 focus-within:bg-black/40 focus:bg-black/40 focus-visible:bg-black/40"
      ...
      {isOpen && (
        <>
          ...
          <Card className="fixed right-6 mt-2 z-50 w-80 bg-black/30 backdrop-blur-md shadow-xl">
